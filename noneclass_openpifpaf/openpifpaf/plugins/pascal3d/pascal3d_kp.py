...
class Pascal3dKp(DataModule):
    """
    DataModule for the Pascal3D+ dataset.
    """

    train_annotations = 'data-pascal3d/annotations_chair/pascal3d_train.json'
    val_annotations = 'data-pascal3d/annotations_chair/pascal3d_val.json'
    eval_annotations = val_annotations ##############################################     important
    train_image_dir = 'data-pascal3d/images_chair/train/'
    val_image_dir = 'data-pascal3d/images_chair/val/'
    ...
    def cli(cls, parser: argparse.ArgumentParser):
        group = parser.add_argument_group('data module pascal3d')

        group.add_argument('--pascal3d-train-annotations',
                           default=cls.train_annotations)
        group.add_argument('--pascal3d-val-annotations',
                           default=cls.val_annotations)
        group.add_argument('--pascal3d-train-image-dir',
                           default=cls.train_image_dir)
        group.add_argument('--pascal3d-val-image-dir',
                           default=cls.val_image_dir)

        group.add_argument('--pascal3d-square-edge',
                           default=cls.square_edge, type=int,
                           help='square edge of input images')
        assert not cls.extended_scale
        group.add_argument('--pascal3d-extended-scale',
                           default=False, action='store_true',
                           help='augment with an extended scale range')
        group.add_argument('--pascal3d-orientation-invariant',
                           default=cls.orientation_invariant, type=float,
                           help='augment with random orientations')
        group.add_argument('--pascal3d-blur',
                           default=cls.blur, type=float,
                           help='augment with blur')
        assert cls.augmentation
        group.add_argument('--pascal3d-no-augmentation',
                           dest='pascal3d_augmentation',
                           default=True, action='store_false',
                           help='do not apply data augmentation')
        group.add_argument('--pascal3d-rescale-images',
                           default=cls.rescale_images, type=float,
                           help='overall rescale factor for images')
        group.add_argument('--pascal3d-upsample',
                           default=cls.upsample_stride, type=int,
                           help='head upsample stride')
        group.add_argument('--pascal3d-min-kp-anns',
                           default=cls.min_kp_anns, type=int,
                           help='filter images with fewer keypoint annotations')
        group.add_argument('--pascal3d-bmin',
                           default=cls.b_min, type=int,
                           help='b minimum in pixels')
        group.add_argument('--pascal3d-apply-local-centrality-weights',
                           dest='pascal3d_apply_local_centrality',
                           default=False, action='store_true',
        ...
        group.add_argument('--pascal3d-no-eval-annotation-filter',
                           dest='pascal3d_eval_annotation_filter',
                           default=True, action='store_false')
        group.add_argument('--pascal3d-eval-long-edge', default=cls.eval_long_edge, type=int,
                           help='set to zero to deactivate rescaling')
        assert not cls.eval_extended_scale
        group.add_argument('--pascal3d-eval-extended-scale', default=False, action='store_true')
        group.add_argument('--pascal3d-eval-orientation-invariant',
                           default=cls.eval_orientation_invariant, type=float)
        group.add_argument('--pascal3d-use-10-kps', default=False, action='store_true',
                           help=(' '))
    ...
    def configure(cls, args: argparse.Namespace):
        ...
        # pascal3d specific
        cls.train_annotations = args.pascal3d_train_annotations
        cls.val_annotations = args.pascal3d_val_annotations
        cls.eval_annotations = cls.val_annotations
        cls.train_image_dir = args.pascal3d_train_image_dir
        cls.val_image_dir = args.pascal3d_val_image_dir
        cls.eval_image_dir = cls.val_image_dir

        cls.square_edge = args.pascal3d_square_edge
        cls.extended_scale = args.pascal3d_extended_scale
        cls.orientation_invariant = args.pascal3d_orientation_invariant
        cls.blur = args.pascal3d_blur
        cls.augmentation = args.pascal3d_augmentation  # loaded by the dest name
        cls.rescale_images = args.pascal3d_rescale_images
        cls.upsample_stride = args.pascal3d_upsample
        cls.min_kp_anns = args.pascal3d_min_kp_anns
        cls.b_min = args.pascal3d_bmin
        ...
        # evaluation
        cls.eval_annotation_filter = args.pascal3d_eval_annotation_filter
        cls.eval_long_edge = args.pascal3d_eval_long_edge
        cls.eval_orientation_invariant = args.pascal3d_eval_orientation_invariant
        cls.eval_extended_scale = args.pascal3d_eval_extended_scale

        if args.pascal3d_apply_local_centrality:
            '''
            if args.pascal3d_use_10_kps:
