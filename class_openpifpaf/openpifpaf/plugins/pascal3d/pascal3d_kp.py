...
class Pascal3dKp(DataModule):
    ...
    train_annotations = 'data-pascal3d/annotations_all/pascal3d_train.json'
    val_annotations = 'data-pascal3d/annotations_all/pascal3d_val.json'
    eval_annotations = val_annotations ##############################################     important
    train_image_dir = 'data-pascal3d/images_all/train/'
    val_image_dir = 'data-pascal3d/images_all/val/'
