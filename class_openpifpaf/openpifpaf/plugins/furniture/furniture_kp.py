...
class FurnitureKp(DataModule):
    ...
    val_annotations = 'data-keypoint-5/annotations_chair/keypoint5_val.json'
    eval_annotations = val_annotations ##############################################     important
    train_image_dir = 'data-keypoint-5/images_chair/train/'
    val_image_dir = 'data-keypoint-5/images_chair/val/'
    ...
    def __init__(self):
        ...
        if self.weights is not None:
            ...
            caf_weights = None
        cif = headmeta.Cif('cif', 'furniture',
        ...
        caf = headmeta.Caf('caf', 'furniture',
                           keypoints=self.FURNITURE_KEYPOINTS,
                           sigmas=self.FURNITURE_SIGMAS,
                           pose=self.FURNITURE_POSE,
