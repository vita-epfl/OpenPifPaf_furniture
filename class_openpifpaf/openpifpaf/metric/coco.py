...
###################################  Get right category when evaluating   ##################################
################  This ensure that the evaloader get right image-label pairs
################  Currently precision for classification is not evaluated
            catego_id = 0
            if image_id/1000000 < 10:
                catego_id = int(image_id/1000000) 
            elif image_id/10000000000 < 10:
                catego_id = int(int(image_id/1000000)%10)+1
            elif image_id/1000000000000000 < 10:
                catego_id = int(int(image_id/100000000)%10)+1

            pred_data['category_id'] = catego_id
#############################################################################################################
        ...
        if not image_annotations:
            ...
            image_annotations.append({
                'image_id': image_id,
                'category_id': catego_id,   # When specifying category
